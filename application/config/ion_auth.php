 ...
 */
$config['site_title']                 = "Strater CI.com";       // Site Title, example.com
$config['admin_email']                = "admin@starterci.com"; // Admin Email, admin@example.com
 ...
 */
$config['remember_cookie_name'] = 'starter_123';
